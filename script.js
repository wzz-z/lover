...
noButton.addEventListener("click", function () {
    ...
    if (clickCount === 1) mainImage.src = "./images/f1.png";  
    // 思考 修改为绝对路径  
    // if (clickCount === 2) mainImage.src = "./images/think.png";  
    if (clickCount === 2) mainImage.src = "./images/f2.png";  
    // 生气 修改为绝对路径  
    // if (clickCount === 3) mainImage.src = "./images/angry.png"; 
    if (clickCount === 3) mainImage.src = "./images/f3.png"; 
    // 哭 修改为绝对路径    
...
yesButton.addEventListener("click", function () {
    document.body.innerHTML = `
        <div class="yes-screen">
            <h1 class="yes-text">!!!喜欢小红!! ( >᎑<)♡︎ᐝ</h1>
            <img src="./images/z1.png" alt="拥抱" class="yes-image">   
        </div>
    `;
